...
namespace ModeloParcialWebApi.Repositories.Utils
{
    public class DataHelper
    {
        ...
        private DataHelper()
        {
            _connection = new SqlConnection(@"Data Source=.\SQLEXPRESS;Initial Catalog=db_cine;Integrated Security=True;Encrypt=False");
        }
